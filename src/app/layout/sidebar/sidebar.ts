  ...
  grupos: NavGrupo[] = [
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icono: 'clipboard',
          roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista'],
        },
        {
        ...
        },
        {
          ...
          roles: ['administrador', 'fisioterapeuta', 'director', 'recepcionista', 'paciente'],
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: 'Turnos',
          ruta: '/app/admin/turnos',
          icono: 'clock',
          roles: ['administrador', 'director', 'fisioterapeuta', 'recepcionista'],
        },
        {
          label: 'Asistencias',
          ruta: '/app/admin/asistencias',
          icono: 'check-circle',
          roles: ['administrador', 'director', 'fisioterapeuta', 'recepcionista'],
        },
      ],
